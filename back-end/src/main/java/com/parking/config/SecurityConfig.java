    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/reportes/eficiencia/**").hasAnyAuthority("ROLE_OPERADOR", "ROLE_operador", "ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/export/csv/financieros-avanzado").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
                .requestMatchers(HttpMethod.GET, "/reportes/export/pdf/resumen-ejecutivo").hasAnyAuthority("ROLE_ADMIN", "ROLE_admin")
